...
class LoopUnitTests {
    ...
    public void unitLoopSumTest() {
        int check = LoopsExamples.sumInt(new int[]{16, 20, 21, 23});
        assertEquals(80, check, "Sum did not work");
        check = LoopsExamples.sumInt(new int[]{16, 20, 21, 253, 567, 323, 7809});
    ...
    public void unitLoopSumNegitveNumbersTest() {
        ...
        check = LoopsExamples.sumInt(new int[]{-16, -20, -21, 23});
        assertEquals(-34, check, "If passed a negative number sum did not work");
    }

    @Test
    public void unitLoopMaxTest() {
        int check = LoopsExamples.findLargest(new int[]{16, 20, 21, 23});
        assertEquals(23, check, "Find largest did not work");
        check = LoopsExamples.findLargest(new int[]{1677, 2000, 2441, 2389});
    ...
    public void findPrimeNumbersNoneUnitTest() {
        assertEquals(-1, LoopsExamples.findFirstPrimeNumber(new int[]{12, 14, 18, 22, 28}),
            "Prime finding returned incorrect value when no prime number should be found");
        assertEquals(-1, LoopsExamples.findFirstPrimeNumber(new int[]{4}), "Prime finding returned incorrect value when no prime number should be found");
    }

    @Test
    public void findPrimeNumbersUnitTest() {
        assertEquals(11, LoopsExamples.findFirstPrimeNumber(new int[]{12, 14, 18, 22, 11}), "Prime finding returned incorrect value");
        assertEquals(23, LoopsExamples.findFirstPrimeNumber(new int[]{4, 56, 23, 89, 11}), "Prime finding returned incorrect value");
    }

    @Test
    public void testMultiplicationTables() {
        LoopsExamples.printOutCalculationTable(6);
    ...
    public void testSmallMultiplicationTables() {
        LoopsExamples.printOutCalculationTable(3);
        assertEquals("1   2   3\n"
            + "   2   4   6\n"
    ...
    public void testSmallMultiplicationAdvancedTables() {
        ...
        LoopsExamples.printOutCalculationTable(6, 9);
    ...
    public void testMultiplicationAdvancedTables() {
        ...
        LoopsExamples.printOutCalculationTable(9, 13);
    ...
    public void testStringSearchArray() {
        var found = LoopsExamples.findSomethingInText("star", new String[]{"seastar", "Patrick", "Patrick seastar",
