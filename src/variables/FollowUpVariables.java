...
public class FollowUpVariables {
    ...
    public static void main(String[] args) {
        ...
        short age = 26, size = 5, lengthInCm = 175;

        double growthMetric = 13.5, heightInMeters = 1.1, averageAge = 25.5;
        ...
        double resultOfDivision = 1.0/3.0;
        ...
        System.out.println("next fraction should be 98! : " + (int) (100.0 / 60 * minutes)); //int gets rid of commas
        System.out.println("next fraction should be 98! : " +  (minutes * 100/60)); //changing places make the calculation different
        ...
        // create new class - add variables with constructors. 3 functions cm to inch, cm to foot, meters to yards
