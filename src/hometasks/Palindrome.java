...
public class Palindrome {
    ...
    public static boolean isStringPalindrome(String input) {
        input = input.toLowerCase().replaceAll("[^a-zа-я]", ""); //no difference: upper or lower case, with spaces or without
    ...
    public static void main(String[] args) {
        ...
        System.out.println(isStringPalindrome("Red apple"));
        System.out.println(isStringPalindrome("Eva, can I see bees in a cave?"));
    }
}
